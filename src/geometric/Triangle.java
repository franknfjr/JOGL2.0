...
public class Triangle implements IShape{
    ...
    public void draw(GL2 gl) {
      gl.glClear( GL2.GL_COLOR_BUFFER_BIT | GL2.GL_DEPTH_BUFFER_BIT );
        ...
        //Front
        gl.glTexCoord2f(0.0f, 1.0f); gl.glVertex3f( 1.0f, 2.0f, 0.0f ); // Top Of Triangle (Front)
       // gl.glColor3f( 0.0f, 1.0f, 0.0f ); // Green
        gl.glTexCoord2f(0.0f, 0.0f); gl.glVertex3f( -1.0f, -1.0f, 1.0f ); // Left Of Triangle (Front)
        //gl.glColor3f( 0.0f, 0.0f, 1.0f ); // Blue
        gl.glTexCoord2f(1.0f, 1.0f); gl.glVertex3f( 1.0f, -1.0f, 1.0f ); // Right Of Triangle (Front)
